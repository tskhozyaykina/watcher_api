...
package ru.tkhozyaykina.apitest.pojo.auth.response.profile;
...
public class User {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("firstName", firstName).append("role", role).append("lastName", lastName).append("email", email).append("id", id).append("isStaff", isStaff).append("additionalProperties", additionalProperties).toString();
    }
