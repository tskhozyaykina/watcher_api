...
public class ErrorToken {
    ...
    public ErrorToken withError(Error error) {
        this.error = error;
        return this;
    }
    ...
    public ErrorToken withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ErrorToken) == false) {
            return false;
        }
        ErrorToken rhs = ((ErrorToken) other);
